    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 max-w-7xl  lg:px-0">
        <div className="mx-auto max-w-2xl py-8 lg:max-w-7xl">
                  ...
                  <div key={product.id} className="">
                    ...
                    <div className="mb-2 flex">
                      <div className="min-w-24 flex">
                        <button type="button" className="h-7 w-7" onClick={()=>dispatch(decrementQuantity(product))}>
                          -
                        </button>
                      ...
                      <div className="ml-6 flex text-sm">
                        ...
                        >
                          ...
                          <span className="text-xs font-medium text-red-500 cursor-pointer" onClick={()=>removingFromCart(product)}>
                            Remove
                          </span>
                        </button>
                      </div>
          ...
          </div>:<><div className=" h-screen flex items-center  justify-center gap-3.5 mx ">
            <h1>No Items Found</h1>
          <Link className='rounded-md' to={'/'}> Go to Home</Link>
          </div></>
...
console.log('component rendrered');
